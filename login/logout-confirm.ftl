            ...
            <form class="form-actions" action="${url.logoutConfirmAction}" onsubmit="confirmLogout.disabled = true; return true;" method="POST">
                ...
                <div class="${properties.kcFormGroupClass!}">
                    ...
                    <div id="kc-form-buttons" class="${properties.kcFormGroupClass!} flex flex-row flex-center">
                        <input tabindex="4"
                               class="btn btn-secondary mx-auto w-6/12 m-3 ${properties.kcButtonClass!} ${properties.kcButtonPrimaryClass!} ${properties.kcButtonBlockClass!} ${properties.kcButtonLargeClass!}"
